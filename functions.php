...
[data-icon="myicon"]::before { 
    background: url('https://modern-websites.de/wp-content/uploads/2020/05/test_16x16.png'); 
    content:'a' !important; 
...
<script>
jQuery('.et-pb-icon').filter(function(){ return jQuery(this).text() == 'myicon'; }).html('<img src="https://modern-websites.de/wp-content/uploads/2020/05/test_96x96.png"/>');
</script>
<?php
}
