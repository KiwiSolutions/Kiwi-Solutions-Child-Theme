...
jQuery(document).ready(function() {
    ...
    jQuery('#Heatmaps_ButtonActive_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').hide();
    jQuery('#Heatmaps_Image_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').hide();
    ...
    // ========
    //Besucheraufnahme
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').hide();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_benutzeraktionen_notizen').hide();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_unterstuetzt_tastenanschlaege').hide();
    jQuery('#analyse_besucheraufnahmen_image_unterstuetzt_tastenanschlaege').hide();
    //================
    //Konvertierungstunnel
    jQuery('#analyse_konvertierungstunnel_button_inactive_unbegrenzte_schritte').hide();
    jQuery('#analyse_konvertierungstunnel_button_active_abbrueche_von_aufnahmen').hide();
    jQuery('#analyse_konvertierungstunnel_section_abbrueche_von_aufnahmen').hide();
    //====================
    //Effektive Formularanalyse
    jQuery('#analyse_effektive_formularanalyse_button_inactive_visualisieren_form_feldeinsaetze').hide();
    jQuery('#analyse_effektive_formularanalyse_button_active_problemfelder_identifizieren').hide();
    jQuery('#analyse_effektive_formularanalyse_section_problemfelder_identifizieren').hide();
    jQuery('#analyse_effektive_formularanalyse_button_active_drop-offs_einrichtungsstatistiken').hide();
    jQuery('#analyse_effektive_formularanalyse_section_drop-offs_einrichtungsstatistiken').hide();
    //=========================
    //Feedback Polls
    jQuery('#analyse_feedback_polls_button_inactive_direktes_feedback_seitenbesucher').hide();
    ...
    jQuery('#analyse_feedback_polls_button_active_feedback_ergebnisse_visualisieren').hide();
    jQuery('#analyse_feedback_polls_section_feedback_ergebnisse_visualisieren').hide();
    ...
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').hide();
    jQuery('#analyse_eingehendes_feedback_button_active_visuelles_feedback_dashboard').hide();
    jQuery('#analyse_eingehendes_feedback_section_visuelles_feedback_dashboard').hide();
    jQuery('#analyse_eingehendes_feedback_button_active_gefuehls_ueberwachung').hide();
    jQuery('#analyse_eingehendes_feedback_section_gefuehls_ueberwachung').hide();
    jQuery('#analyse_eingehendes_feedback_button_active_anpassbares_widget').hide();
    jQuery('#analyse_eingehendes_feedback_section_anpassbares_widget').hide();
    //====================
    //Umfragen starten
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').hide();
    ...
    jQuery('#analyse_umfragen_starten_button_active_weitere_besucher_einladen').hide();
    jQuery('#analyse_umfragen_starten_section_weitere_besucher_einladen').hide();
    jQuery('#analyse_umfragen_starten_button_active_ergebnisse_visualisieren').hide();
    jQuery('#analyse_umfragen_starten_section_ergebnisse_visualisieren').hide();
    //================
    // Testnutzer generieren
    jQuery('#analyse_testnutzer_generieren_button_inactive_rekrutieren_sie_teilnehmer').hide();
    jQuery('#analyse_testnutzer_generieren_button_active_details_der_befragten').hide();
    jQuery('#analyse_testnutzer_generieren_section_details_der_befragten').hide();
    jQuery('#analyse_testnutzer_generieren_button_active_anpassbares_widget').hide();
    ...
    jQuery('#Heatmaps_ButtonClosed_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').show();
    ...
    jQuery('#Heatmaps_ButtonClosed_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').click(function(e){
    e.preventDefault();
    jQuery('#Heatmaps_ButtonActive_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').show();
    jQuery('#Heatmaps_Image_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').show();
    ...
    jQuery('#Heatmaps_ButtonClosed_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').hide();
    jQuery('#Heatmaps_ButtonActive_Klicken_Sie_auf_Heatmaps').hide();
    jQuery('#Heatmaps_Image_Klicken_Sie_auf_Heatmaps').hide();
    jQuery('#Heatmaps_ButtonActive_Heatmaps_verschieben').hide();
    jQuery('#Heatmaps_Image_Heatmaps_verschieben').hide();
    ...
    jQuery('#Heatmaps_ButtonActive_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').click(function(e){
    e.preventDefault();
    jQuery('#Heatmaps_ButtonClosed_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').show();
    jQuery('#Heatmaps_Image_Laden_Sie_Heatmaps_herunter_und_geben_Sie_sie_frei').show();
    ...
    jQuery('#Heatmaps_ButtonClosed_Heatmaps_nach_Gerätetyp_aufgeteilt').click(function(e){
    e.preventDefault();
    ...
    jQuery('#Heatmaps_ButtonActive_Heatmaps_nach_Gerätetyp_aufgeteilt').click(function(e){
    e.preventDefault();
    jQuery('#Heatmaps_ButtonActive_Heatmaps_nach_Gerätetyp_aufgeteilt').show();
    jQuery('#Heatmaps_Image_Heatmaps_nach_Gerätetyp_aufgeteilt').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_benutzeraktionen_notizen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_unterstuetzt_tastenanschlaege').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').show();
    jQuery('#analyse_besucheraufnahmen_image_wiederholungssitzungen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_tag_recordings').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_tag_recordings').click(function(e){
    e.preventDefault();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_benutzeraktionen_notizen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_aufnahmen_teilen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_aufnahmen_filtern').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_unterstuetzt_tastenanschlaege').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').hide();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_tag_recordings').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_tag_recordings').show();
    jQuery('#analyse_besucheraufnahmen_image_tag_recordings').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_benutzeraktionen_notizen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_benutzeraktionen_notizen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_benutzeraktionen_notizen').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_image_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_tag_recordings').hide();
    jQuery('#analyse_besucheraufnahmen_image_tag_recordings').hide();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_benutzeraktionen_notizen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_benutzeraktionen_notizen').show();
    jQuery('#analyse_besucheraufnahmen_image_benutzeraktionen_notizen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_aufnahmen_teilen').click(function(e){
    e.preventDefault();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_aufnahmen_teilen').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_image_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_tag_recordings').hide();
    jQuery('#analyse_besucheraufnahmen_image_tag_recordings').hide();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_aufnahmen_teilen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_aufnahmen_teilen').show();
    jQuery('#analyse_besucheraufnahmen_image_aufnahmen_teilen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_aufnahmen_filtern').click(function(e){
    e.preventDefault();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_aufnahmen_filtern').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_image_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_tag_recordings').hide();
    jQuery('#analyse_besucheraufnahmen_image_tag_recordings').hide();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_aufnahmen_filtern').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_aufnahmen_filtern').show();
    jQuery('#analyse_besucheraufnahmen_image_aufnahmen_filtern').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_unterstuetzt_tastenanschlaege').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_unterstuetzt_tastenanschlaege').show();
    jQuery('#analyse_besucheraufnahmen_image_unterstuetzt_tastenanschlaege').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_tag_recordings').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_benutzeraktionen_notizen').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_aufnahmen_teilen').show();
    ...
    jQuery('#analyse_besucheraufnahmen_button_inactive_unterstuetzt_tastenanschlaege').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_image_wiederholungssitzungen').hide();
    jQuery('#analyse_besucheraufnahmen_button_active_tag_recordings').hide();
    jQuery('#analyse_besucheraufnahmen_image_tag_recordings').hide();
    ...
    jQuery('#analyse_besucheraufnahmen_button_active_unterstuetzt_tastenanschlaege').click(function(e){
    e.preventDefault();
    jQuery('#analyse_besucheraufnahmen_button_active_unterstuetzt_tastenanschlaege').show();
    jQuery('#analyse_besucheraufnahmen_image_unterstuetzt_tastenanschlaege').show();
    jQuery('#analyse_besucheraufnahmen_button_inactive_wiederholungssitzungen').show();
    ...
    jQuery('#analyse_konvertierungstunnel_button_inactive_unbegrenzte_schritte').click(function(e){
    e.preventDefault();
    jQuery('#analyse_konvertierungstunnel_button_active_unbegrenzte_schritte').show();
    jQuery('#analyse_konvertierungstunnel_section_unbegrenzte_schritte').show();
    jQuery('#analyse_konvertierungstunnel_button_inactive_abbrueche_von_aufnahmen').show();
    ...
    jQuery('#analyse_konvertierungstunnel_button_active_unbegrenzte_schritte').click(function(e){
    e.preventDefault();
    jQuery('#analyse_konvertierungstunnel_button_active_unbegrenzte_schritte').show();
    jQuery('#analyse_konvertierungstunnel_section_unbegrenzte_schritte').show();
    jQuery('#analyse_konvertierungstunnel_button_inactive_abbrueche_von_aufnahmen').show();
    ...
    jQuery('#analyse_konvertierungstunnel_button_inactive_abbrueche_von_aufnahmen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_konvertierungstunnel_button_active_abbrueche_von_aufnahmen').show();
    jQuery('#analyse_konvertierungstunnel_section_abbrueche_von_aufnahmen').show();
    jQuery('#analyse_konvertierungstunnel_button_inactive_unbegrenzte_schritte').show();
        
    jQuery('#analyse_konvertierungstunnel_button_inactive_abbrueche_von_aufnahmen').hide();
    jQuery('#analyse_konvertierungstunnel_button_active_unbegrenzte_schritte').hide();
    ...
    jQuery('#analyse_konvertierungstunnel_button_active_abbrueche_von_aufnahmen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_konvertierungstunnel_button_active_abbrueche_von_aufnahmen').show();
    jQuery('#analyse_konvertierungstunnel_section_abbrueche_von_aufnahmen').show();
    jQuery('#analyse_konvertierungstunnel_button_inactive_unbegrenzte_schritte').show();
    ...
    jQuery('#analyse_effektive_formularanalyse_button_inactive_visualisieren_form_feldeinsaetze').click(function(e){
    e.preventDefault();
    jQuery('#analyse_effektive_formularanalyse_button_active_visualisieren_form_feldeinsaetze').show();
    jQuery('#analyse_effektive_formularanalyse_section_visualisieren_form_feldeinsaetze').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_problemfelder_identifizieren').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_drop-offs_einrichtungsstatistiken').show();	
    ...
    jQuery('#analyse_effektive_formularanalyse_button_active_visualisieren_form_feldeinsaetze').click(function(e){
    e.preventDefault();
    jQuery('#analyse_effektive_formularanalyse_button_active_visualisieren_form_feldeinsaetze').show();
    jQuery('#analyse_effektive_formularanalyse_section_visualisieren_form_feldeinsaetze').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_problemfelder_identifizieren').show();
    ...
    jQuery('#analyse_effektive_formularanalyse_button_inactive_problemfelder_identifizieren').click(function(e){
    e.preventDefault();
    jQuery('#analyse_effektive_formularanalyse_button_active_problemfelder_identifizieren').show();
    jQuery('#analyse_effektive_formularanalyse_section_problemfelder_identifizieren').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_visualisieren_form_feldeinsaetze').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_drop-offs_einrichtungsstatistiken').show();	
        
    jQuery('#analyse_effektive_formularanalyse_button_inactive_problemfelder_identifizieren').hide();
    jQuery('#analyse_effektive_formularanalyse_button_active_visualisieren_form_feldeinsaetze').hide();
    jQuery('#analyse_effektive_formularanalyse_section_visualisieren_form_feldeinsaetze').hide();
    jQuery('#analyse_effektive_formularanalyse_button_active_drop-offs_einrichtungsstatistiken').hide();
    jQuery('#analyse_effektive_formularanalyse_section_drop-offs_einrichtungsstatistiken').hide();
    });
    //========================================================
    ...
    jQuery('#analyse_effektive_formularanalyse_button_active_problemfelder_identifizieren').click(function(e){
    e.preventDefault();
    jQuery('#analyse_effektive_formularanalyse_button_active_problemfelder_identifizieren').show();
    jQuery('#analyse_effektive_formularanalyse_section_problemfelder_identifizieren').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_visualisieren_form_feldeinsaetze').show();
    ...
    jQuery('#analyse_effektive_formularanalyse_button_inactive_drop-offs_einrichtungsstatistiken').click(function(e){
    e.preventDefault();
    jQuery('#analyse_effektive_formularanalyse_button_active_drop-offs_einrichtungsstatistiken').show();
    jQuery('#analyse_effektive_formularanalyse_section_drop-offs_einrichtungsstatistiken').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_visualisieren_form_feldeinsaetze').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_problemfelder_identifizieren').show();	
        
    jQuery('#analyse_effektive_formularanalyse_button_inactive_drop-offs_einrichtungsstatistiken').hide();
    jQuery('#analyse_effektive_formularanalyse_button_active_visualisieren_form_feldeinsaetze').hide();
    jQuery('#analyse_effektive_formularanalyse_section_visualisieren_form_feldeinsaetze').hide();
    jQuery('#analyse_effektive_formularanalyse_button_active_problemfelder_identifizieren').hide();
    jQuery('#analyse_effektive_formularanalyse_section_problemfelder_identifizieren').hide();
    ...
    jQuery('#analyse_effektive_formularanalyse_button_active_drop-offs_einrichtungsstatistiken').click(function(e){
    e.preventDefault();
    jQuery('#analyse_effektive_formularanalyse_button_active_drop-offs_einrichtungsstatistiken').show();
    jQuery('#analyse_effektive_formularanalyse_section_drop-offs_einrichtungsstatistiken').show();
    jQuery('#analyse_effektive_formularanalyse_button_inactive_visualisieren_form_feldeinsaetze').show();
    ...
    jQuery('#analyse_feedback_polls_button_inactive_direktes_feedback_seitenbesucher').click(function(e){
    e.preventDefault();
    jQuery('#analyse_feedback_polls_button_active_direktes_feedback_seitenbesucher').show();
    jQuery('#analyse_feedback_polls_section_direktes_feedback_seitenbesucher').show();
    jQuery('#analyse_feedback_polls_button_inactive_mehrere_fragetypen').show();
    jQuery('#analyse_feedback_polls_button_inactive_feedback_ergebnisse_visualisieren').show();	
    ...
    jQuery('#analyse_feedback_polls_button_active_direktes_feedback_seitenbesucher').click(function(e){
    e.preventDefault();
    jQuery('#analyse_feedback_polls_button_active_direktes_feedback_seitenbesucher').show();
    jQuery('#analyse_feedback_polls_section_direktes_feedback_seitenbesucher').show();
    jQuery('#analyse_feedback_polls_button_inactive_mehrere_fragetypen').show();
    ...
    jQuery('#analyse_feedback_polls_button_inactive_mehrere_fragetypen').click(function(e){
    e.preventDefault();
    ...
    jQuery('#analyse_feedback_polls_button_inactive_direktes_feedback_seitenbesucher').show();
    jQuery('#analyse_feedback_polls_button_inactive_feedback_ergebnisse_visualisieren').show();	
    jQuery('#analyse_feedback_polls_button_inactive_anpassbares_widget').show();
    
    jQuery('#analyse_feedback_polls_button_inactive_mehrere_fragetypen').hide();
    jQuery('#analyse_feedback_polls_button_active_direktes_feedback_seitenbesucher').hide();
    jQuery('#analyse_feedback_polls_section_direktes_feedback_seitenbesucher').hide();
    jQuery('#analyse_feedback_polls_button_active_feedback_ergebnisse_visualisieren').hide();
    jQuery('#analyse_feedback_polls_section_feedback_ergebnisse_visualisieren').hide();
    jQuery('#analyse_feedback_polls_button_active_anpassbares_widget').hide();
    jQuery('#analyse_feedback_polls_section_anpassbares_widget').hide();
    ...
    jQuery('#analyse_feedback_polls_button_active_mehrere_fragetypen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_feedback_polls_button_active_mehrere_fragetypen').show();
    jQuery('#analyse_feedback_polls_section_mehrere_fragetypen').show();
    jQuery('#analyse_feedback_polls_button_inactive_direktes_feedback_seitenbesucher').show();
    ...
    jQuery('#analyse_feedback_polls_button_inactive_feedback_ergebnisse_visualisieren').click(function(e){
    e.preventDefault();
    jQuery('#analyse_feedback_polls_button_active_feedback_ergebnisse_visualisieren').show();
    jQuery('#analyse_feedback_polls_section_feedback_ergebnisse_visualisieren').show();
    jQuery('#analyse_feedback_polls_button_inactive_direktes_feedback_seitenbesucher').show();
    jQuery('#analyse_feedback_polls_button_inactive_mehrere_fragetypen').show();	
    jQuery('#analyse_feedback_polls_button_inactive_anpassbares_widget').show();
    
    jQuery('#analyse_feedback_polls_button_inactive_feedback_ergebnisse_visualisieren').hide();
    jQuery('#analyse_feedback_polls_button_active_direktes_feedback_seitenbesucher').hide();
    jQuery('#analyse_feedback_polls_section_direktes_feedback_seitenbesucher').hide();
    jQuery('#analyse_feedback_polls_button_active_mehrere_fragetypen').hide();
    jQuery('#analyse_feedback_polls_section_mehrere_fragetypen').hide();
    ...
    jQuery('#analyse_feedback_polls_button_active_feedback_ergebnisse_visualisieren').click(function(e){
    e.preventDefault();
    jQuery('#analyse_feedback_polls_button_active_feedback_ergebnisse_visualisieren').show();
    jQuery('#analyse_feedback_polls_section_feedback_ergebnisse_visualisieren').show();
    jQuery('#analyse_feedback_polls_button_inactive_direktes_feedback_seitenbesucher').show();
    ...
    jQuery('#analyse_feedback_polls_button_inactive_anpassbares_widget').click(function(e){
    e.preventDefault();
    ...
    jQuery('#analyse_feedback_polls_button_active_anpassbares_widget').click(function(e){
    e.preventDefault();
    jQuery('#analyse_feedback_polls_button_active_anpassbares_widget').show();
    jQuery('#analyse_feedback_polls_section_anpassbares_widget').show();
    jQuery('#analyse_feedback_polls_button_inactive_direktes_feedback_seitenbesucher').show();
    ...
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_feedback_kontext').show();
    jQuery('#analyse_eingehendes_feedback_section_feedback_kontext').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_visuelles_feedback_dashboard').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_gefuehls_ueberwachung').show();	
    jQuery('#analyse_eingehendes_feedback_button_inactive_anpassbares_widget').show();
    ...
    jQuery('#analyse_eingehendes_feedback_button_active_feedback_kontext').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_feedback_kontext').show();
    jQuery('#analyse_eingehendes_feedback_section_feedback_kontext').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_visuelles_feedback_dashboard').show();
    ...
    jQuery('#analyse_eingehendes_feedback_button_inactive_visuelles_feedback_dashboard').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_visuelles_feedback_dashboard').show();
    jQuery('#analyse_eingehendes_feedback_section_visuelles_feedback_dashboard').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_gefuehls_ueberwachung').show();	
    jQuery('#analyse_eingehendes_feedback_button_inactive_anpassbares_widget').show();
    
    jQuery('#analyse_eingehendes_feedback_button_inactive_visuelles_feedback_dashboard').hide();
    ...
    jQuery('#analyse_eingehendes_feedback_button_active_visuelles_feedback_dashboard').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_visuelles_feedback_dashboard').show();
    jQuery('#analyse_eingehendes_feedback_section_visuelles_feedback_dashboard').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').show();
    ...
    jQuery('#analyse_eingehendes_feedback_button_inactive_gefuehls_ueberwachung').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_gefuehls_ueberwachung').show();
    jQuery('#analyse_eingehendes_feedback_section_gefuehls_ueberwachung').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_visuelles_feedback_dashboard').show();	
    jQuery('#analyse_eingehendes_feedback_button_inactive_anpassbares_widget').show();
    
    jQuery('#analyse_eingehendes_feedback_button_inactive_gefuehls_ueberwachung').hide();
    jQuery('#analyse_eingehendes_feedback_button_active_feedback_kontext').hide();
    jQuery('#analyse_eingehendes_feedback_section_feedback_kontext').hide();
    jQuery('#analyse_eingehendes_feedback_button_active_visuelles_feedback_dashboard').hide();
    jQuery('#analyse_eingehendes_feedback_section_visuelles_feedback_dashboard').hide();
    ...
    jQuery('#analyse_eingehendes_feedback_button_active_gefuehls_ueberwachung').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_gefuehls_ueberwachung').show();
    jQuery('#analyse_eingehendes_feedback_section_gefuehls_ueberwachung').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').show();
    ...
    jQuery('#analyse_eingehendes_feedback_button_inactive_anpassbares_widget').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_anpassbares_widget').show();
    jQuery('#analyse_eingehendes_feedback_section_anpassbares_widget').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_visuelles_feedback_dashboard').show();	
    jQuery('#analyse_eingehendes_feedback_button_inactive_gefuehls_ueberwachung').show();
    
    jQuery('#analyse_eingehendes_feedback_button_inactive_anpassbares_widget').hide();
    jQuery('#analyse_eingehendes_feedback_button_active_feedback_kontext').hide();
    jQuery('#analyse_eingehendes_feedback_section_feedback_kontext').hide();
    jQuery('#analyse_eingehendes_feedback_button_active_visuelles_feedback_dashboard').hide();
    jQuery('#analyse_eingehendes_feedback_section_visuelles_feedback_dashboard').hide();
    ...
    jQuery('#analyse_eingehendes_feedback_button_active_anpassbares_widget').click(function(e){
    e.preventDefault();
    jQuery('#analyse_eingehendes_feedback_button_active_anpassbares_widget').show();
    jQuery('#analyse_eingehendes_feedback_section_anpassbares_widget').show();
    jQuery('#analyse_eingehendes_feedback_button_inactive_feedback_kontext').show();
    ...
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_umfragen_starten_button_active_benutzerfreundliche_umfragen').show();
    jQuery('#analyse_umfragen_starten_section_benutzerfreundliche_umfragen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_mehrere_fragetypen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_weitere_besucher_einladen').show();	
    jQuery('#analyse_umfragen_starten_button_inactive_ergebnisse_visualisieren').show();
    ...
    jQuery('#analyse_umfragen_starten_button_active_benutzerfreundliche_umfragen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_umfragen_starten_button_active_benutzerfreundliche_umfragen').show();
    jQuery('#analyse_umfragen_starten_section_benutzerfreundliche_umfragen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_mehrere_fragetypen').show();
    ...
    jQuery('#analyse_umfragen_starten_button_inactive_mehrere_fragetypen').click(function(e){
    e.preventDefault();
    ...
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_weitere_besucher_einladen').show();	
    jQuery('#analyse_umfragen_starten_button_inactive_ergebnisse_visualisieren').show();
    
    jQuery('#analyse_umfragen_starten_button_inactive_mehrere_fragetypen').hide();
    jQuery('#analyse_umfragen_starten_button_active_benutzerfreundliche_umfragen').hide();
    jQuery('#analyse_umfragen_starten_section_benutzerfreundliche_umfragen').hide();
    jQuery('#analyse_umfragen_starten_button_active_weitere_besucher_einladen').hide();
    jQuery('#analyse_umfragen_starten_section_weitere_besucher_einladen').hide();
    jQuery('#analyse_umfragen_starten_button_active_ergebnisse_visualisieren').hide();
    jQuery('#analyse_umfragen_starten_section_ergebnisse_visualisieren').hide();
    ...
    jQuery('#analyse_umfragen_starten_button_active_mehrere_fragetypen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_umfragen_starten_button_active_mehrere_fragetypen').show();
    jQuery('#analyse_umfragen_starten_section_mehrere_fragetypen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').show();
    ...
    jQuery('#analyse_umfragen_starten_button_inactive_weitere_besucher_einladen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_umfragen_starten_button_active_weitere_besucher_einladen').show();
    jQuery('#analyse_umfragen_starten_section_weitere_besucher_einladen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_mehrere_fragetypen').show();	
    jQuery('#analyse_umfragen_starten_button_inactive_ergebnisse_visualisieren').show();
    
    jQuery('#analyse_umfragen_starten_button_inactive_weitere_besucher_einladen').hide();
    jQuery('#analyse_umfragen_starten_button_active_benutzerfreundliche_umfragen').hide();
    jQuery('#analyse_umfragen_starten_section_benutzerfreundliche_umfragen').hide();
    jQuery('#analyse_umfragen_starten_button_active_mehrere_fragetypen').hide();
    jQuery('#analyse_umfragen_starten_section_mehrere_fragetypen').hide();
    ...
    jQuery('#analyse_umfragen_starten_button_active_weitere_besucher_einladen').click(function(e){
    e.preventDefault();
    jQuery('#analyse_umfragen_starten_button_active_weitere_besucher_einladen').show();
    jQuery('#analyse_umfragen_starten_section_weitere_besucher_einladen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').show();
    ...
    jQuery('#analyse_umfragen_starten_button_inactive_ergebnisse_visualisieren').click(function(e){
    e.preventDefault();
    jQuery('#analyse_umfragen_starten_button_active_ergebnisse_visualisieren').show();
    jQuery('#analyse_umfragen_starten_section_ergebnisse_visualisieren').show();
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').show();
    jQuery('#analyse_umfragen_starten_button_inactive_mehrere_fragetypen').show();	
    jQuery('#analyse_umfragen_starten_button_inactive_weitere_besucher_einladen').show();
    
    jQuery('#analyse_umfragen_starten_button_inactive_ergebnisse_visualisieren').hide();
    jQuery('#analyse_umfragen_starten_button_active_benutzerfreundliche_umfragen').hide();
    jQuery('#analyse_umfragen_starten_section_benutzerfreundliche_umfragen').hide();
    jQuery('#analyse_umfragen_starten_button_active_mehrere_fragetypen').hide();
    jQuery('#analyse_umfragen_starten_section_mehrere_fragetypen').hide();
    ...
    jQuery('#analyse_umfragen_starten_button_active_ergebnisse_visualisieren').click(function(e){
    e.preventDefault();
    jQuery('#analyse_umfragen_starten_button_active_ergebnisse_visualisieren').show();
    jQuery('#analyse_umfragen_starten_section_ergebnisse_visualisieren').show();
    jQuery('#analyse_umfragen_starten_button_inactive_benutzerfreundliche_umfragen').show();
    ...
    jQuery('#analyse_testnutzer_generieren_button_inactive_rekrutieren_sie_teilnehmer').click(function(e){
    e.preventDefault();
    jQuery('#analyse_testnutzer_generieren_button_active_rekrutieren_sie_teilnehmer').show();
    jQuery('#analyse_testnutzer_generieren_section_rekrutieren_sie_teilnehmer').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_details_der_befragten').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_anpassbares_widget').show();	
    ...
    jQuery('#analyse_testnutzer_generieren_button_active_rekrutieren_sie_teilnehmer').click(function(e){
    e.preventDefault();
    jQuery('#analyse_testnutzer_generieren_button_active_rekrutieren_sie_teilnehmer').show();
    jQuery('#analyse_testnutzer_generieren_section_rekrutieren_sie_teilnehmer').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_details_der_befragten').show();
    ...
    jQuery('#analyse_testnutzer_generieren_button_inactive_details_der_befragten').click(function(e){
    e.preventDefault();
    jQuery('#analyse_testnutzer_generieren_button_active_details_der_befragten').show();
    jQuery('#analyse_testnutzer_generieren_section_details_der_befragten').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_rekrutieren_sie_teilnehmer').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_anpassbares_widget').show();	
    
    jQuery('#analyse_testnutzer_generieren_button_inactive_details_der_befragten').hide();
    jQuery('#analyse_testnutzer_generieren_button_active_rekrutieren_sie_teilnehmer').hide();
    jQuery('#analyse_testnutzer_generieren_section_rekrutieren_sie_teilnehmer').hide();
    jQuery('#analyse_testnutzer_generieren_button_active_anpassbares_widget').hide();
    jQuery('#analyse_testnutzer_generieren_section_anpassbares_widget').hide();
    });
    //========================================================
    ...
    jQuery('#analyse_testnutzer_generieren_button_active_details_der_befragten').click(function(e){
    e.preventDefault();
    jQuery('#analyse_testnutzer_generieren_button_active_details_der_befragten').show();
    jQuery('#analyse_testnutzer_generieren_section_details_der_befragten').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_rekrutieren_sie_teilnehmer').show();
    ...
    jQuery('#analyse_testnutzer_generieren_button_inactive_anpassbares_widget').click(function(e){
    e.preventDefault();
    jQuery('#analyse_testnutzer_generieren_button_active_anpassbares_widget').show();
    jQuery('#analyse_testnutzer_generieren_section_anpassbares_widget').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_rekrutieren_sie_teilnehmer').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_details_der_befragten').show();	
    
    jQuery('#analyse_testnutzer_generieren_button_inactive_anpassbares_widget').hide();
    jQuery('#analyse_testnutzer_generieren_button_active_rekrutieren_sie_teilnehmer').hide();
    jQuery('#analyse_testnutzer_generieren_section_rekrutieren_sie_teilnehmer').hide();
    jQuery('#analyse_testnutzer_generieren_button_active_details_der_befragten').hide();
    jQuery('#analyse_testnutzer_generieren_section_details_der_befragten').hide();
    ...
    jQuery('#analyse_testnutzer_generieren_button_active_anpassbares_widget').click(function(e){
    e.preventDefault();
    jQuery('#analyse_testnutzer_generieren_button_active_anpassbares_widget').show();
    jQuery('#analyse_testnutzer_generieren_section_anpassbares_widget').show();
    jQuery('#analyse_testnutzer_generieren_button_inactive_rekrutieren_sie_teilnehmer').show();
...
jQuery(document).ready(function() {
    // Hide things on Page websites
    jQuery('#table_section').hide();
    jQuery('.table_section_closed').hide();
    jQuery('.websites_zusatzleistungen_section').hide();
    jQuery('.websites_zusatzpakete_button_inactive').hide();
    jQuery('.websites_zusatzleistungen_button_active').hide();
    /*jQuery('#additional_services_section1').hide();
    jQuery('#additional_services_section2').hide();*/
    //=============================
    });
    ...
    // TABLE OPEN
    jQuery('.table_section_open').click(function(e){
    e.preventDefault();
    jQuery("#table_section").slideToggle();
    jQuery('.table_section_closed').show();
    jQuery('.table_section_open').hide();
    jQuery('.table_section_open').toggleClass('opened closed');
    });
    // ==========
    
    jQuery('.price_table_more_details').click(function(e){
    e.preventDefault();
    jQuery("#table_section").slideToggle();
    jQuery('.table_section_closed').show();
    jQuery('.table_section_open').hide();
    ...
    //TABLE CLOSE
    jQuery('.table_section_closed').click(function(e){
    e.preventDefault();
    jQuery("#table_section").slideToggle();
    jQuery('.table_section_closed').hide();
    jQuery('.table_section_open').show();
    jQuery('.table_section_open').toggleClass('opened closed');
    window.scrollTo(0, 4300);
    });
    //===========
         
    //OTHER FUNCTIONS ON PAGE WEBSITES	 
    jQuery('.websites_zusatzpakete_button_inactive').click(function(e){
    e.preventDefault();
    jQuery('.websites_zusatzleistungen_section').hide();
    jQuery('.websites_zusatzpakete_button_inactive').hide();
    jQuery('.websites_zusatzleistungen_button_active').hide();
    jQuery('.websites_zusatzpakete_section').show();
    jQuery('.websites_zusatzpakete_button_active').show();
    jQuery('.websites_zusatzleistungen_button_inactive').show();
    });
    
    
    jQuery('.websites_zusatzpakete_button_active').click(function(e){
    e.preventDefault();
    jQuery('.websites_zusatzleistungen_section').hide();
    jQuery('.websites_zusatzpakete_button_inactive').hide();
    jQuery('.websites_zusatzleistungen_button_active').hide();
    ...
    jQuery('.websites_zusatzleistungen_button_inactive').click(function(e){
    e.preventDefault();
    jQuery('.websites_zusatzpakete_section').hide();
    jQuery('.websites_zusatzpakete_button_active').hide();
    jQuery('.websites_zusatzleistungen_button_inactive').hide();
    jQuery('.websites_zusatzleistungen_section').show();
    jQuery('.websites_zusatzpakete_button_inactive').show();
    jQuery('.websites_zusatzleistungen_button_active').show();
    });
        
        
    jQuery('.websites_zusatzleistungen_button_active').click(function(e){
    e.preventDefault();
    jQuery('.websites_zusatzpakete_section').hide();
    jQuery('.websites_zusatzpakete_button_active').hide();
    jQuery('.websites_zusatzleistungen_button_inactive').hide();
